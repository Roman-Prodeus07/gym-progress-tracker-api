# Gym Progress Tracker API — API Reference

This document contains detailed endpoint behaviour, request and response
examples, validation rules, domain semantics and security decisions for the
Gym Progress Tracker API.

For the project overview, architecture, engineering highlights, quality gates
and setup instructions, see the [main README](../README.md).
...
- Datetimes are timezone-aware ISO 8601 values
- Missing and foreign owner-scoped resources return the same `404 Not Found`
